        ...
        try {
            ...
            if (configuration.findProviderMetadata().getUserInfoEndpointURI() != null && accessToken != null) {
                ...
                if (userInfoResponse instanceof UserInfoErrorResponse) {
                    ...
                    //remove the "memberof" attribute
                    Map<String,Object> claimsMap = userInfoClaimsSet.getClaims();
                    Map<String,Object> filtedClaimsMap = new HashMap<>();
                    for(String key : claimsMap.keySet()) {
                        if ("memberof".equalsIgnoreCase(key)) {
                            continue;
                        }
                        filtedClaimsMap.put(key, claimsMap.get(key));
                    }



                    getProfileDefinition().convertAndAdd(profile, filtedClaimsMap, null);
                }
            }
