...
import { UpdateDatasourceMutation } from '../../../../../graphql/datasource.generated';
...
type Props = {
    ...
    onUpdate: (
        description: string,
    ) => Promise<FetchResult<UpdateDatasourceMutation, Record<string, any>, Record<string, any>> | void>;
};
