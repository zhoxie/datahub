...
import { Datasource, Maybe, UsageAggregation } from '../../../../types.generated';
...
export default function QueriesTab({ datasource }: Props) {
    const topQueries = getTopNQueries(5, datasource.usageStats?.buckets);
