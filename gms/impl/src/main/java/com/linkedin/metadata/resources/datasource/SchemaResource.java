 ...
 *
 * Rest.li entry point: /datasources/{datasourceKey}/schema
 */
@Slf4j
@Deprecated
@RestLiCollection(name = "schema", namespace = "com.linkedin.datasource", parent = Datasources.class)
public class SchemaResource extends BaseDatasourceVersionedAspectResource<SchemaMetadata> {
