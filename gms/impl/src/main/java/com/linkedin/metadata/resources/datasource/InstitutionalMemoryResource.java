...
@Slf4j
@Deprecated
@RestLiCollection(name = "institutionalMemory", namespace = "com.linkedin.datasource", parent = Datasources.class)
public class InstitutionalMemoryResource extends BaseDatasourceVersionedAspectResource<InstitutionalMemory> {
