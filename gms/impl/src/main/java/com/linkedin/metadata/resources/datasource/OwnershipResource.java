...
@Slf4j
@Deprecated
@RestLiCollection(name = "rawOwnership", namespace = "com.linkedin.datasource", parent = Datasources.class)
public class OwnershipResource extends BaseDatasourceVersionedAspectResource<Ownership> {
